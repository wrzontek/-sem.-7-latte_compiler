...
#line 1923 "Parser.C"
  ...
  case 42:
#line 223 "Latte.y"
                     { (yyval.complexstart_) = new NewObject((yyvsp[0].typename_)); (yyval.complexstart_)->line_number = (yyloc).first_line; (yyval.complexstart_)->char_number = (yyloc).first_column; }
#line 1929 "Parser.C"
    break;
